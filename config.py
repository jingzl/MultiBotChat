...
# API基础URL
# 尝试多个可能的端口（8080 和 8000）
API_BASE_URL = os.getenv('MULTIBOT_API_BASE_URL', 'http://127.0.0.1:8000')
...
# http://oneapi.tlab.turbig.com/
# http://127.0.0.1:11434/v1
BASS_LLM_MODEL = os.getenv('MULTIBOT_BASE_LLM_MODEL', 'qwen2.5:7b')
BASS_LLM_BASE_URL = os.getenv('MULTIBOT_BASE_LLM_BASE_URL', 'http://oneapi.tlab.turbig.com/v1')
BASS_LLM_API_KEY = os.getenv('MULTIBOT_BASE_LLM_API_KEY', 'sk-96jl4cT87BJcvT806cC7EaB4967d46A89e3f5e792e7020Df')