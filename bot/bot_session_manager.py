...
class BotSessionManager:
    def __init__(self, username):
        ...
        self.all_bots_speak = False  # 新增：是否所有机器人同时回答
        self.all_bots_as_audience = False  # 新增：是否所有机器人加入观众
        self.chat_config = {
            'history_length': 10,
    ...
    def save_data_to_file(self):
        ...
        data = {
            ...
            'all_bots_speak': self.all_bots_speak,  # 保存新设置项
            'all_bots_as_audience': self.all_bots_as_audience,  # 保存"所有机器人加入观众"设置
    ...
    def get_all_bots_speak(self):
        return self.all_bots_speak

    def set_all_bots_speak(self, value):
        self.all_bots_speak = value
        self.save_data_to_file()

    def get_all_bots_as_audience(self):
        return self.all_bots_as_audience

    def set_all_bots_as_audience(self, value):
        self.all_bots_as_audience = value
        self.save_data_to_file()
